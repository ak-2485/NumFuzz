...
let f_X input_array = 
  ...
  ((abs_I((var_x *$ ({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ floor_power2_I((ref_1 +$ {low = 0.00000000000000000000e+00; high = 0.00000000000000000000e+00}))))) +$ (abs_I((ref_1 *$ ({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ floor_power2_I(var_x)))) +$ (abs_I(({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ floor_power2_I((ref_2 +$ {low = -2.30215846386272486692e-07; high = 2.30215846386272486692e-07})))) +$ (abs_I(({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ floor_power2_I(var_a0))) +$ abs_I(({low = 2.00000000000000000000e+00; high = 2.00000000000000000000e+00} *$ floor_power2_I((ref_3 +$ {low = -3.49425249623891484778e-07; high = 3.49425249623891484778e-07})))))))) /$ abs_I(ref_3))
